...
class AndroidAsyncSettings(private val context: Context) : AsyncSettings {
...
actual val asyncSettings: AsyncSettings get() = AndroidAsyncSettings(UtilsLibrary.context)
